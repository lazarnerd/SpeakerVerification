...
parser.add_argument(
    "--nDataLoaderThread", type=int, default=5, help="Number of loader threads"
)
parser.add_argument("--augment", type=bool, default=False, help="Augment input")
parser.add_argument(
    "--seed", type=int, default=10, help="Seed for the random number generator"
)
...
parser.add_argument(
    "--max_epoch", type=int, default=500, help="Maximum number of epochs"
)
...
parser.add_argument(
    "--weight_decay", type=float, default=0, help="Weight decay in the optimizer"
)
...
parser.add_argument(
    "--nOut", type=int, default=512, help="Embedding size in the last FC layer"
)
parser.add_argument(
    "--sinc_stride",
    type=int,
